...
fn main() {
    ...
    while total_matches < scanners.len() - 1 {
        ...
        for i in 0..scanners.len() {
            ...
            let score = do_matches_against(i, &mut ms, &mut scanners, &rots, &sign, &mut status);
            total_matches += score;
            current_score += score;
    ...
    fn do_matches_against(idx: usize, ms: &mut Vec<__m256i>, scanners: &mut Vec<Vec<__m256i>>, rots: &[[usize; 2]; 24], sign: &Vec<__m256i>, status: &mut Vec<bool>) -> usize {
        ...
        'smatch: for si in 1..scanners.len() {
            ...
            'rmatch: for ri in 0..24 {
                ...
                'pmatch: for offi in 0..src_cmp.len() {
                    ...
                    'slpmatch: for offj in 0..scanner.len() * 2 {
                        ...
                        unsafe {
                            ...
                            'bmatch: for ii in 0..src_cmp.len() {
    ...
    for i in 0..8 {
        unsafe {
            test_xv = _mm256_sign_epi32(scanners[0][0], sign[i]);
        }
